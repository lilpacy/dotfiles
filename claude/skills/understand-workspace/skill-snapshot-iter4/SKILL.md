...
|---|---|---|---|
| typo・設定値・依存bump・単純削除・リネーム | 各1-3文（Code は省略可） | しない（省略を明示） | しない |
...
**正解と解説は必ず全問分を出力に含める**。出題だけして正解を伏せると、
読者は答え合わせのために追加のやりとりを強いられる。問題の直後に置くと
目に入ってしまうので、全問題の後に「解答と解説」をまとめて置く。
